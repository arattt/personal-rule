...
write_sourcelist(){
	if [ -n "$koolproxy_sourcelist" ];then
		...
		cat > $KP_DIR/data/source.list <<-EOF
			1|koolproxy.txt|https://github.com/arattt/personal-rule/blob/main/rules/koolproxy.txt|
			1|daily.txt|https://github.com/arattt/personal-rule/blob/main/rules/daily.txt|
			1|kp.dat|https://github.com/arattt/personal-rule/blob/main/rules/kp.dat|
			1|user.txt||
